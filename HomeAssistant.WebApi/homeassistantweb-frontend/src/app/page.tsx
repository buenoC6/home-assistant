          ...
          <AccordionItem value="item-1">
            ...
            <AccordionContent>
              ...
              <Drawer>
                ...
                <DrawerContent>
                  <DrawerHeader className={'flex flex-wrap gap-2'}>
                    <Card style={{ width: '49%' }}>
                      <CardHeader className={'p-1.5'}>
                        <CardTitle className={'flex justify-center pt-1'}>
                          <Image
                    ...
                    <Card style={{ width: '49%' }}>
                      ...
                      <CardContent className={'pt-2'}>
                        <div className={'text-center'}>
                          <span className={'text-xl'}>
                            {solar?.realKpi?.monthEnergy?.toFixed(2)}
                          </span>{' '}
                          <span className={'text-gray-500'}>kWh</span>
                        </div>
                        <div className={'text-center'}>
                    ...
                    <Card style={{ width: '49%' }}>
                      ...
                      <CardContent className={'pt-2'}>
                        <div className={'text-center'}>
                          <span className={'text-xl'}>
                            {formatCustom(solar?.realKpi?.yearEnergy)}
                          </span>{' '}
                          <span className={'text-gray-500'}>MWh</span>
                        </div>
                        <div className={'text-center'}>
                    ...
                    <Card style={{ width: '49%' }}>
                      ...
                      <CardContent className={'pt-2'}>
                        <div className={'text-center'}>
                          <span className={'text-xl'}>
                            {formatCustom(solar?.realKpi.cumulativeEnergy)}
                          </span>{' '}
                          <span className={'text-gray-500'}>MWh</span>
                        </div>
                        <div className={'text-center'}>
