...
export function SolarProduction() {
  ...
  return (
    <>
      <div>
        {data && data.powerCurve.xAxis.length > 0 && (
      ...
      >
        <SolarUnitCard
          number={data?.realKpi.realTimePower}
          label={'En temps réel'}
          imageUrl={
        ...
        />
        <SolarUnitCard
          number={data?.realKpi.dailyEnergy}
      ...
      <Drawer>
        ...
        <DrawerContent>
          <DrawerHeader className={'grid grid-cols-2 gap-3'}>
            ...
            />
            <SolarUnitCard
              number={Number(data?.realKpi?.monthEnergy?.toFixed(2))}
              label={'Ce mois'}
              imageUrl={
            ...
            />
            <SolarUnitCard
              number={Number(formatCustom(data?.realKpi?.yearEnergy))}
              label={'Cette année'}
              imageUrl={
            ...
            />
            <SolarUnitCard
              number={Number(formatCustom(data?.realKpi.cumulativeEnergy))}
